    ...
    varieties: [
      {
        ...
        additionalInfo:
          "High nutritional value,Tolerant to bolting, excellent shelf life, good for short-term harvest",
        category: "Vegetables",
      },
    ],
  },
    ...
    varieties: [
      {
        ...
        maturity: "55–60 Days",
        additionalInfo:
          "Intermediate resistance to powdery mildew and field tolerance to virus",
        category: "Vegetables",
      },
      {
    ...
    varieties: [
      {
        ...
        plantType: "",
        plantHabit:
          "The plants are generally tall (often 60–150 cm), erect, and vigorous",
        maturity: "70–80 Days",
        additionalInfo:
    ...
    varieties: [
      {
        ...
        fruitShape:
          "Oval to oblong fruits have light green   rind with dark green stripes",
        fruitWeight: "8-10 kg",
        fruiteSize: "",
        yield: "",
        plantHeight: "Vining Type",
        plantType: "",
        plantHabit: "Vigorous and prolific hybrid.",
        maturity: "75–80 Days",
        additionalInfo:
          "Good earliness with better fruit size and good flesh quality Suitable For Long Transportation",
        category: "Fruits",
      },
      {
        slug: "tandy",
        ...
        maturity: "65–70 Days",
        additionalInfo:
          "High yield, Suitable for Long Distance Shipping, Compact flesh",
        category: "Fruits",
      },
    ],
  },
